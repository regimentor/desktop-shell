...
[Архитектура](architecture.md) · [Панель](bar.md) ·
[Уведомления](notifications.md) · [Снимок исходников](launcher-source.md)
...
Добавьте пример из `examples/hyprland-launcher.lua`, заменив прежний bind:
